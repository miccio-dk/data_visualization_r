...
\author{Riccardo Miccini  Eren Can Gungor}
\date{\today}
...
Using R will be easy in Google Query.  There are already pre-made packages such as "assertthat" and "bigrquery". Both packages has been specifically made for implementing R in Google Query. Both Packages has been made by Hadley Wickham.
}
...
\begin{itemize}
\item Creating a project in Google Cloud Platform Console
\item Enabling Billing for your project
\item Enabling the BigQuery API access
\end{itemize}
...
\frame{\frametitle{Testing the environment}
To test the main functionalities, the following can been done
\begin{itemize}
