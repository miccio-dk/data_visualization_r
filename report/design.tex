...
This method of acquiring data is more effective and efficient than polling the current known location, as it provides finer control o the accuracy and frequency of the updates (through the previously mentioned \code{LocationRequest} object).
...
The location data is contained in a \code{Location} data object that stores latitude, longitude, heading, speed, and many other GPS-related measures.
